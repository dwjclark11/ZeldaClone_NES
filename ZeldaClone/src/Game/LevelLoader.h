...
public:
	...
	void LoadLevelFromLuaTable(sol::state& lua, std::string fileName, const std::unique_ptr<Registry>& registry, const std::unique_ptr<AssetManager>& assetManager, SDL_Renderer* renderer);
