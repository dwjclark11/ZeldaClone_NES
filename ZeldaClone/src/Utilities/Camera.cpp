...
Camera::Camera(int x, int y, int width, int height)
	: mCamera{}, m_LeftRect{ 0, 256, 512, 704 }, m_RightRect{ 512, 256, 512, 704 }, m_ScreenFlash{0, 256, 1024, 704}
	, m_FadeAlpha{255}
	, mZoom{1.f}
	, m_bCameraMoving{false}
	, m_bStartFadeIn{false}, m_bStartFadeOut{false}
	, m_bStartOpen{false}, m_bStartClose{false}
	, m_bCurtainOpen{false}, m_bCurtainClosed{false}
	, m_bFadeFinished{true}, m_bStartScreenFlash{false}
	, m_FlashIndex{ 0 }, m_PrevCamX{ 7168 }, m_PrevCamY{ 4448 }
	, m_FlashOnTimer{}, m_FlashOffTimer{}
{
	mCamera.x = x;
	mCamera.y = y;
	mCamera.w = width;
