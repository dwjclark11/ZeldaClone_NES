...
private:
	...
	*/
	SDL_Rect mCamera, m_LeftRect, m_RightRect, m_ScreenFlash;
	Uint8 m_FadeAlpha;
	float mZoom;
...
public:
	...
	*/
	inline const float GetZoom() const { return mZoom; }
	...
	*/
	...
	inline void SetPrevCamPosition(int x, int y) { m_PrevCamX = x; m_PrevCamY = y; }
